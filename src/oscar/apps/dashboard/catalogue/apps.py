...
class CatalogueDashboardConfig(OscarDashboardConfig):
    ...
    def get_urls(self):
        urls = [
            ...
            path('categories/create/<int:parent>',
            ...
            re_path(r'^option/(?P<pk>\w+)/update/$',
                self.option_update_view.as_view(),
                name='catalogue-option-update'),
            re_path(r'^option/(?P<pk>\w+)/delete/$',
