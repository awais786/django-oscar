...
class VouchersDashboardConfig(OscarDashboardConfig):
    ...
    def get_urls(self):
        urls = [
            ...
            path('sets', self.set_list_view.as_view(),
                name='voucher-set-list'),
            path('sets/create/', self.set_create_view.as_view(),
                name='voucher-set-create'),
            path('sets/update/<int:pk>/', self.set_update_view.as_view(),
                name='voucher-set-update'),
            path('sets/<int:pk>/', self.set_detail_view.as_view(),
                name='voucher-set'),
            path('sets/<int:pk>/download', self.set_download_view.as_view(),
